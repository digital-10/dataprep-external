...
public class ListenerTrigger3 implements TriggerListener {
	...
	public void triggerFired(Trigger trigger, JobExecutionContext context) {
		...
		if(null != jobRunningStartTime) {
			jobRunningStartTime.set(2, DateFormatUtils.format(new Date(), "yyyy-MM-dd HH:mm:ss.SSS", Locale.KOREA));
	...
	public void triggerComplete(Trigger trigger, JobExecutionContext context, CompletedExecutionInstruction triggerInstructionCode) {
		...
		if(null != jobRunningEndTime) {
			jobRunningEndTime.set(2, DateFormatUtils.format(new Date(), "yyyy-MM-dd HH:mm:ss.SSS", Locale.KOREA));
